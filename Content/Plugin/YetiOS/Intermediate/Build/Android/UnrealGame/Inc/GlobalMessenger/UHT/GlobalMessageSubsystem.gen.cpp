...
void FGlobalMessageReceiveDelegate_DelegateWrapper(const FScriptDelegate& GlobalMessageReceiveDelegate, UObject* Payload)
{
	...
	UGlobalMessageSubsystem::~UGlobalMessageSubsystem() {}
	struct Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_OperatingSystemSimulator_Source_GlobalMessenger_Public_GlobalMessageSubsystem_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_OperatingSystemSimulator_Source_GlobalMessenger_Public_GlobalMessageSubsystem_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_OperatingSystemSimulator_Source_GlobalMessenger_Public_GlobalMessageSubsystem_h_2854642462(TEXT("/Script/GlobalMessenger"),
		Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_OperatingSystemSimulator_Source_GlobalMessenger_Public_GlobalMessageSubsystem_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_OperatingSystemSimulator_Source_GlobalMessenger_Public_GlobalMessageSubsystem_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
