...
public:
	...
	UOperatingSystemDeviceMessenger* GetDeviceMessenger() const;
	...
	FORCEINLINE TSoftClassPtr<UOperatingSystemDeviceMessenger> GetMessengerClass() const { return MessengerClass; }
