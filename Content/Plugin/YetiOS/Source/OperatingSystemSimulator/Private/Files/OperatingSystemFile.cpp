	...
	, FileWidget(nullptr)
{
	...
	CTOR_LOAD_CLASS(UUserWidget, IconWidgetClass, "/OperatingSystemSimulator/OperatingSystemContent/Shared/Blueprints/Widgets/Icons/WBP_FileIcon");
}
...
void UOperatingSystemFile::OpenFile(FGenericError& OutError)
{
	...
	ParentProgram = ParentExplorerInterface->GetOperatingSystem()->GetInstalledProgram(TargetProgramClass);
