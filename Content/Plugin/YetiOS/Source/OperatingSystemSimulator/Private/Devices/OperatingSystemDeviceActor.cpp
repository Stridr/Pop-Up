...
AOperatingSystemDeviceActor::AOperatingSystemDeviceActor()
	...
	, MessengerClass(UOperatingSystemDeviceMessenger::StaticClass())
...
UOperatingSystemDeviceMessenger* AOperatingSystemDeviceActor::GetDeviceMessenger() const
{
	if (IsValid(CurrentDevice))
	{
		return CurrentDevice->GetMessenger();
	}
