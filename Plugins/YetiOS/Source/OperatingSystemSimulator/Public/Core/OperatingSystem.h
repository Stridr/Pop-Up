...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FOnProgramClosed, UOperatingSystemBaseProgram*, ClosedProgram);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FOnProgramStarted, UOperatingSystemBaseProgram*, StartedProgram);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FOnProgramInstalled, UOperatingSystemBaseProgram*, InstalledProgram);
...
protected:
	...
	/** All users for this Operating System. */
...
public:
	...
	FOnProgramStarted OnProgramStarted;

	UPROPERTY(BlueprintAssignable, Category = OperatingSystem)
	FOnProgramClosed OnProgramClosed;
...
public:
	...
	**/
	...
	UFUNCTION(BlueprintPure, Category = OperatingSystem)
	UOperatingSystemBaseProgram* IsProgramInstalled(const TSoftClassPtr<UOperatingSystemBaseProgram> TestClass) const;
...
public:
	...
	FORCEINLINE TArray<FOperatingSystemUser> GetAllUsers() const { return Users; }
